...
export default {
  ...
  data() {
    return {
      examples: [
        {
          title: 'Default table',
          code: `<div class="hx-prose contents">
  ...
  <table class="hx-table is-striped mt-4 mb-0">
    <thead>
      <tr>
        <th><abbr title="Position">Pos</abbr></th>
        <th>Team</th>
        <th class="text-right"><abbr title="Played">Pld</abbr></th>
        <th class="text-right"><abbr title="Won">W</abbr></th>
        <th class="text-right"><abbr title="Drawn">D</abbr></th>
        <th class="text-right"><abbr title="Lost">L</abbr></th>
        <th class="text-right"><abbr title="Goals for">GF</abbr></th>
        <th class="text-right"><abbr title="Goals against">GA</abbr></th>
        <th class="text-right"><abbr title="Goal difference">GD</abbr></th>
...
<table class="hx-table is-narrow mb-0">
  <thead>
    <tr>
      <th>One</th>
      <th>Two</th>
    ...
    <tr>
      ...
      <td><i class="hx-icon icon-information-outline"></i></td>
        ...
        },
        {
          ...
          code: `<table class="hx-table has-sticky-header">
  <thead>
    <tr>
      <th>Dessert (100g)</th>
    ...
    <tr>
      <td colspan="6">
        ...
        },
        {
          ...
          code: `<p>
  Add <code>class="hx-table-group"</code> to the tbody tag proceeding tbody related rows.
</p>
  ...
  <tbody class="is-hidden">
    <tr class="is-selected">
      ...
      <tr>
        <td>
          <div class="hx-checkbox-control">
            <input 
              id="checkbox-narrow-20" 
              name="20-checkbox-narrow" 
              type="checkbox" 
              class="hx-checkbox" 
              title="Select All" 
            />
    ...
    <tr>
      <td>
        <div class="hx-checkbox-control">
          <input 
            id="checkbox-narrow-21"
            name="21-checkbox-narrow" 
            type="checkbox" 
            class="hx-checkbox" 
            title="Select All" 
          />
    ...
    <tr>
      <th colspan="6">
        <div>
          <div class="hx-checkbox-control">
            <input 
              id="checkbox-narrow-group-2-all" 
              name="checkbox-narrow-group-2-all" 
              type="checkbox" 
              class="hx-checkbox" 
              title="Select All"
            />
  ...
  <tbody>
    <tr>
      <td>
        <div class="hx-checkbox-control">
          <input 
            id="checkbox-narrow-1" 
            name="1-checkbox-narrow" 
            type="checkbox" 
            class="hx-checkbox" 
            checked 
            title="Select All"
    ...
    <tr>
      <td>
        <div class="hx-checkbox-control">
          <input 
            id="checkbox-narrow-2" 
            name="2-checkbox-narrow" 
            type="checkbox" 
            class="hx-checkbox" 
            checked 
            title="Select All"
    ...
    <tr>
      <td>
        <div class="hx-checkbox-control">
          <input 
            id="checkbox-narrow-3" 
            name="3-checkbox-narrow" 
            type="checkbox" 
            class="hx-checkbox" 
            title="Select All"
          />
    ...
    <tr>
      <td>
        <div class="hx-checkbox-control">
          <input 
            id="checkbox-narrow-4" 
            name="4-checkbox-narrow" 
            type="checkbox" 
            class="hx-checkbox" 
            title="Select All"
          />
