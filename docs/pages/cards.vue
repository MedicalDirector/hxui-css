...
export default {
  ...
  <div class="content">
    ...
    <ul>
      <li><code>.highlight-info</code></li>
      <li><code>.highlight-success</code> (default)</li>
      <li><code>.highlight-caution</code></li>
      <li><code>.highlight-warning</code></li>
