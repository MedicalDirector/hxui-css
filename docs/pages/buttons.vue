...
export default {
  ...
  <div class="grid grid-cols-1 phablet:grid-cols-2 gap-4">
    ...
    <div class="hx-bg-primary p-2 flex justify-center">
      <button class="hx-button is-white">
        <span>White</span>
      </button>
      <button class="hx-button is-transparent-inverted">
  ...
  <div class="flex items-center justify-center gap-2">
    <p class="hx-prose inline-block">Focus</p>
  ...
  <div class="flex items-center justify-center gap-2">
    <p class="hx-prose inline-block">Active</p>
