...
// Original: https://github.com/amzn/style-dictionary/blob/main/lib/common/formatHelpers/formattedVariables.js
...
const createPropertyFormatter = require('./create-property-formatter-mod.cjs')
