<template>
  <div class="install">
    ...
    <hr>
    <h3 class="h5">You only need <strong>1 CSS or SCSS file</strong> to use Hx/UI</h3>
...
@import "/node_modules/@hxui/css/dist/static/scss/hxui.scss";
    ...
    <p>For example, let's say you only want the HxUI <strong>grid</strong>. The file is located in the HxUI/scss/components/grid folder. <br>
...
npm start
    ...
    <p>There're basic requirements to run the documentation locally. You will need to install <a href="https://nodejs.org/en/" target="_blank">Node Package Manager(npm)</a> and <a href="https://vuejs.org/" target="_blank">VueJS</a> in order to run the documentation.</p>
