<template>
  <div id="spacing">
    <h1 class="hx-title">Meta Data</h1>
    <h2 class="hx-subtitle">This <code>hx-metadata</code> component displays read-only values, with a similar look and feel as form inputs.</h2>
