<template>
  <div id="modals">
    <h1 class="hx-title">Modal Dialog</h1>
    <h2 class="hx-subtitle">A classic modal overlay, in which you can include any content you want</h2>

    <hr>

    <div class="has-text-centered my-5 py-5">
      <button class="hx-button is-large" @click="demoSimple = true">Open simple modal</button>
      <button class="hx-button is-large" @click="demoTrad = true">Open classic modal</button>
      <button class="hx-button is-large" @click="demoTradSmall = true">Open classic small modal</button>
      <button class="hx-button is-large" @click="demoTradLarge = true">Open classic large modal</button>
    </div>
    ...
    <div class="hx-modal" :class="{ 'is-active': demoTrad || demoTradSmall || demoTradLarge, 'is-small': demoTradSmall, 'is-large': demoTradLarge }">
      <div class="hx-modal-background"></div>
      <div class="hx-modal-card">
        <header class="hx-modal-card-head">
          ...
          <a class="hx-button is-round is-small is-white"  @click="demoTrad = demoTradSmall = demoTradLarge = false;">
        ...
        <footer class="hx-modal-card-foot">
          <a class="hx-button" @click="demoTrad = demoTradSmall = demoTradLarge = false;">Cancel</a>
          <a class="hx-button is-primary" @click="demoTrad = demoTradSmall = demoTradLarge = false;">Save changes</a>
        </footer>
      </div>
    </div>
