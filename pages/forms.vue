...
<div class="hx-input-control">
  ...
  <div class="hx-help">Please enter your email address</div>
</div>
<div class="hx-input-control">
...
<div class="is-perforated mb-9"></div>
...
<div class="hx-input-group">
  <div class="hx-input-control is-danger">
    ...
    <label class="hx-label">Email <sup>*</sup></label>
    <div class="hx-help">Invalid email address</div>
  </div>
...
<div class="hx-input-group">
 <i class="hx-icon icon-person"></i>
  ...
  <i class="hx-icon icon-check-empty is-medium"></i>
</div>
<div class="is-perforated mb-9"></div>
<h6 class="mb-3">With icon and button</h6>
<div class="hx-input-group">
...
<div class="hx-input-control">
  ...
  <label for="textarea-sample" class="hx-label">Textarea label</label>
...
<div class="hx-input-control is-danger">
  ...
  <label for="textarea-sample" class="hx-label">Textarea label</label>
  <div class="hx-help">Error message</div>
</div>
          `
        },
        {
