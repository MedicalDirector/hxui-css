<template>
  <div id="spacing">
    <h1 class="hx-title">Flexbox</h1>
    <h2 class="hx-subtitle">The <code>hx-flexbox</code> component is an abstraction of the flexbox layout.<br>
      It aims at providing a more efficient way to lay out, align and distribute space among items in a container, even when their size is unknown and/or dynamic.</h2>
  ...
  <span class="hx-icon-control mr-2">
    <i class="hx-icon is-medium icon-information"></i>
     ...
     Unlike the grid system it does not have any padding, margins and does not react to breakpoints.<br>
  ...
  <span class="hx-icon-control mr-2">
    <i class="hx-icon is-medium icon-information"></i>
     ...
     This abstraction utility supports most of the flexbox properties. <br>
      However sometimes you may need to just write pure css,
     for example; change the flex-basis values.
        <p><a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/" target="_blank">Click here</a> for a complete guide to flexbox.</p>
  </span>
